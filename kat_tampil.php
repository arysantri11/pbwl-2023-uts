...
<a href="index.php?hal=kat_input">
...
<table class="table-crud">
    ...
    <tr class="body">
        ...
        <td class="text-center" style="width: 20px;">
            <a class="btn-edit" href="index.php?hal=kat_edit&id=<?= $row['kat_id']; ?>">
        ...
        <td class="text-center" style="width: 20px;">
            <a class="btn-delete" href="index.php?hal=kat_delete&id=<?= $row['kat_id']; ?>">
