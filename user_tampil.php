...
<a href="index.php?hal=user_input">
...
<table class="table-crud">
    ...
    <tr class="body">
        ...
        <td class="text-center" style="width: 20px;">
            <a class="btn-edit" href="index.php?hal=user_edit&id=<?= $row['user_id']; ?>">
        ...
        <td class="text-center" style="width: 20px;">
            <a class="btn-delete" href="index.php?hal=user_delete&id=<?= $row['user_id']; ?>">
